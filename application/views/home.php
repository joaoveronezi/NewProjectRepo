			...
			<div class="container">
				<div class="slider-container">
					<div class="intro-text">
						<div class="intro-lead-in">Bem Vindo ao Coaching4Life</div>
						<div class="intro-heading">Onde Só Habitam os Melhores</div>
						<a href="#about" class="page-scroll btn btn-xl">Coach Me</a>
					</div>
				</div>
			</div>
		</header>
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="section-title">
							<h2>SOBRE</h2>
							<p>Nós somos uma agência profissional com o objetivo de levar o conhecimento do drifiting para todo o mundo!</p>
						</div>
					</div>
				</div>
